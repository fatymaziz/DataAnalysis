# This file is not used anywhere. Keeping this file here, it has the functions we did experiments previously, to check the counts of severe, non severe, zero equals and nonzeroequals
import pandas as pd
import numpy as np
...
def calculate_total_counts(data):
    """
    Calculate total number of bugs for each category Severe, NonSevere, NonZERO Equal, Zero Equals.
    ...
    Returns:
        Returns (Revisit this function- F)
    """
    ...
    print("severe counts",total_severecounts)
    print("non severe counts",total_nonseverecounts)
    print("bothZero counts",total_bothZero_counts)
    print("NoZero counts",total_NoZero_counts)
    print("SomethingElse counts",total_somethingElse_counts)
...
#     Severitycounts_list.update(dict_counts)
    
#     print(Severitycounts_list)
...
#         tag = "Neutral_bothNoZero"
        print("Non Zero Equals", Summary)
        tag = nonzero_equal(summaryList, severedictionary_list,nonseveredictionary_list)
    else:
        tag = "Neutral_WithSomethingElse"
#         print("Severe | Nonsevere", mytest_severe, mytest_nonsevere)
...
#             print("wordlists for severe and non-severe",all_data_df)
...
#     nonsevere_threshold = [0.5]
    ...
    for i in possibleThesholdCombination:
     ...
     #delete this line of code------------------------- fatima
        count_test = severeity_counts(severe_randomthreshold,nonsevere_randomthreshold,validation_data, payload_train)
        ...
        result_dictionary_test.update(count_test)
        result_list_test.append(result_dictionary_test)
     #delete this line of code until here-------------------------fatima
  ...
  #delete this line of code until here-------------------------fatima
    calculate_total_counts(result_list_test)
  #delete this line of code until here-------------------------fatima
