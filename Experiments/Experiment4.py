...
with open('lexicon_results4.json', 'w') as json_file:
    json.dump(dictionary_list, json_file)
# store average lexicon results as JSON
with open('lexicon_average_results4.json', 'w') as json_file:
...
with open('ml_results4.json', 'w') as json_file:
     json.dump(mlresponse_list, json_file)
# store average ML results as JSON
with open('ml_average_results4.json', 'w') as json_file:
