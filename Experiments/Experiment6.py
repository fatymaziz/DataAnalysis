#Experiment 6: Severe threshold starts from 0.001 and includes Normal status bugs
import pandas as pd
import numpy as np
...
dictionary_list = []
mlresponse_list = []
file1 = open("output_Experiment6.txt", "w")  # write mode
